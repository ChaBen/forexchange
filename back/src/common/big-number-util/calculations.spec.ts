...
describe('BigNumber util functions', () => {
  ...
  describe('subtractToString', () => {
    it('should return expected value.', () => {
      ...
      expect(subtractToString('1', '2')).toEqual('-1');
      expect(subtractToString(new BigNumber(1), new BigNumber(2))).toEqual(
        '-1',
      );
    });
    ...
    it('should throw if invalid value', () => {
      ...
      expect(() =>
        subtractToString(undefined as any, undefined as any),
      ).toThrow();
  ...
  describe('multipleToString', () => {
    ...
    it('should throw if invalid value', () => {
      ...
      expect(() =>
        multipleToString(undefined as any, undefined as any),
      ).toThrow();
  ...
  describe('divideToString', () => {
    ...
    it('should throw if invalid value', () => {
      ...
      expect(() =>
        divideToString(undefined as any, undefined as any),
      ).toThrow();
