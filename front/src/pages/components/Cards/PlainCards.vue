      ...
      <div class="row">
        <div class="col-md-6 col-lg-3">
          <card type="profile" plain>
            ...
            <div class="card-footer">
              <n-button type="neutral" class="btn-twitter" size="lg" icon round><i
                class="fab fa-twitter"
              /></n-button>
              <n-button type="neutral" class="btn-dribbble" size="lg" icon round><i
                class="fab fa-dribbble"
              /></n-button>
              <n-button type="neutral" class="btn-instagram" size="lg" icon round><i
        ...
        <div class="col-md-6 col-lg-3">
          <card type="profile" plain>
            ...
            <div class="card-footer">
              <n-button class="btn-twitter" icon round><i class="fab fa-twitter" /></n-button>
              <n-button class="btn-facebook" icon round><i class="fab fa-facebook-square" /></n-button>
              <n-button class="btn-google" icon round><i class="fab fa-google" /></n-button>
            </div>
          </card>
        </div>
        <div class="col-md-6 col-lg-3">
        ...
        <div class="col-md-6 col-lg-3">
          <card type="profile" plain>
            ...
            <div class="card-footer">
              <n-button type="primary" simple icon round><i class="fab fa-twitter" /></n-button>
              <n-button type="primary" simple icon round><i class="fab fa-facebook-square" /></n-button>
              <n-button type="primary" simple icon round><i class="fab fa-google" /></n-button>
            </div>
          </card>
        </div>
      </div>
