            ...
            <div class="row pick-size">
              <div class="col-lg-6 col-md-8 col-sm-6">
                ...
                <el-select v-model="filters.color" class="select-default">
                  <el-option class="select-default" value="1" label="Black" />
                  <el-option class="select-default" value="2" label="Gray" />
                  <el-option class="select-default" value="3" label="White" />
                </el-select>
              </div>
              <div class="col-lg-6 col-md-8 col-sm-6">
                ...
                <el-select v-model="filters.size" class="select-default">
                  <el-option class="select-default" value="1" label="Small" />
                  <el-option class="select-default" value="2" label="Medium" />
                  <el-option class="select-default" value="3" label="Large" />
                </el-select>
              </div>
            </div>
          ...
          <div class="section-story-overview">
            <div class="row">
              <div class="col-md-4 ml-auto mr-auto">
                ...
                <div class="image-container" style="background-image: url('img/bg29.jpg')" />
              </div>
              <div class="col-md-4 ml-auto mr-auto">
