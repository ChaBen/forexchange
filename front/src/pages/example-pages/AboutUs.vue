              ...
              <form class="contact-form">
                <div class="row">
                  ...
                  <div class="col-md-4">
                    ...
                    <fg-input>
                      <el-select v-model="form.speciality" class="select-default">
                        <el-option class="select-default" value="1" label="I'm a Designer" />
                        <el-option class="select-default" value="2" label="I'm a Developer" />
                        <el-option class="select-default" value="3" label="I'm a Hero" />
                      </el-select>
                    </fg-input>
                  </div>
                </div>
